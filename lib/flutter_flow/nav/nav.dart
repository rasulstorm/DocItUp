      ...
      routes: [
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              name: CartListWidget.routeName,
              path: CartListWidget.routePath,
              builder: (context, params) => CartListWidget(),
            ),
            FFRoute(
              name: MedicineCategoriesWidget.routeName,
              path: MedicineCategoriesWidget.routePath,
              builder: (context, params) => MedicineCategoriesWidget(),
            ),
            FFRoute(
            ...
            FFRoute(
              name: ChatAgentWidget.routeName,
              path: ChatAgentWidget.routePath,
              builder: (context, params) => ChatAgentWidget(),
            ),
            FFRoute(
            ...
            FFRoute(
              name: ChattestWidget.routeName,
              path: ChattestWidget.routePath,
